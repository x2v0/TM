*** !!! Внимание !!! 04.04.2021 - проект в процессе переделки ***
...
## Использование TM.dll в качестве динамической библиотеки 

Каждый из файлов содержит встроенный C# код, который использует **TM.dll**, как динамическую библиотеку. 

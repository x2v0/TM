...
// параметры подключения к устройству через протокол линклиб
   ...
   */
   ...
   public class ComData
   {
      ...
      /// номер COM порта  
      /// </summary>
      [Description("The COM port number")]
      public int comport
      {
         get;
         set;
   ...
   /// </summary>
   public partial class TMDataServer : IDisposable
   {
      public static List<TMDataServer> DataServers = new List<TMDataServer>();
      ...
      public EServerConnectType ConnectType
      {
         get;
         set;
      }
      ...
      public EServerConnectType ConnectAvailable
      {
         get;
         set;
      }
